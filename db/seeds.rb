...
articles = {
  intercity_car: [
    ...
    },
    {
        ...
        excerpt: 'Personalised cab to go to dehradun',
        content: 'Personalised cab to go to dehradun',
        ui_type: 1,
        hover_button_type: 1,
        thumbmedia_url: "/img/category/delhitodehradun.jpeg",
    },
    {
        title: 'Delhi to Shimla',
        slug: 'delhi-to-shimla',
        excerpt: 'Personalised cab to go to Shimla',
        content: 'Personalised cab to go to Shimla',
        ui_type: 1,
        hover_button_type: 1,
        thumbmedia_url: "/img/category/shimla.jpg",
    },
    {
        title: 'Delhi to Ladakh',
        slug: 'delhi-to-ladakh',
        excerpt: 'Personalised cab to go to Ladakh',
        content: 'Personalised cab to go to Ladakh',
        ui_type: 1,
        hover_button_type: 1,
        thumbmedia_url: "/img/category/ladakh.jpeg",
    },
    {
        title: 'Delhi to Rishikesh',
        slug: 'delhi-to-rishikesh',
        excerpt: 'Personalised cab to go to Rishikesh',
        content: 'Personalised cab to go to Rishikesh',
        ui_type: 1,
        hover_button_type: 1,
        thumbmedia_url: "/img/category/rishikesh.jpeg",
    },
    {
        title: 'Delhi to Spiti Valley',
        slug: 'delhi-to-spitivalley',
        excerpt: 'Personalised cab to go to Spiti valley',
        content: 'Personalised cab to go to Spiti valley',
        ui_type: 1,
        hover_button_type: 1,
        thumbmedia_url: "/img/category/Spiti-Valley-BIke-Trip.jpg",
    },
    {
        title: 'Delhi to Manali',
        slug: 'delhi-to-manali',
        excerpt: 'Personalised cab to go to Manali',
        content: 'Personalised cab to go to Manali',
        ui_type: 1,
        hover_button_type: 1,
        thumbmedia_url: "/img/category/bike-trip.png",
    }
  ]
}
